...
\noindent\href{https://github.com/sukhlotey/Finance-Flow}{\textbf{Finance Flow}}  \hfill \textbf{August 2024} 
	...
	\begin{itemize}
		\item \textbf{Technology/Tools:} MERN(MongoDb, ExpressJS, ReactJS, NodeJS), Typescript(TSX), Clerk auth
		      \bulletSpace
            	\item Live: \faicon{globe} \href{https://personal-financeflow.netlify.app/auth}
  {\underline{Finance Flow}}
		\item Source: \faicon{github} \href{https://github.com/sukhlotey/Finance-Flow}
  {\underline{Finance Flow}}
	\end{itemize}
 ...
 \newpage
	...
	\begin{itemize}
		\item \textbf{Technology/Tools:} ReactJS, coingecko api, ThreeJS libraries
		      \bulletSpace
		\item working demo: \faicon{globe} \href{https://cryptowarehouse.netlify.app/}{\underline{Crypto Ware}}
           \item Source: \faicon{github} \href{https://github.com/sukhlotey/Crypto-Ware}{\underline{Crypto Ware}}
	\end{itemize}
	% ------------- end project 2 ------------- %
		% ------------- project 3 ------------- %
